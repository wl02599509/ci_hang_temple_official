...
ActiveRecord::Schema[8.1].define(version: 2026_04_25_010012) do
  ...
  create_table "activity_registrations", force: :cascade do |t|
    ...
    t.index ["activity_id", "user_id"], name: "index_activity_registrations_on_activity_id_and_user_id", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "status", default: 99, null: false
    t.datetime "updated_at", null: false
    t.integer "zodiac", comment: "生肖"
