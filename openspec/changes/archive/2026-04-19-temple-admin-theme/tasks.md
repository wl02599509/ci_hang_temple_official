...
- [x] 5.1 啟動 `bin/dev`，確認 Header、Sidebar active、按鈕均顯示朱砂紅
- [x] 5.2 確認 Dashboard 頁面背景為米白，標題為 Noto Serif TC
- [x] 5.3 確認登入頁面（`/admin/users/sign_in`）表單邊框為淺金色，focus 顯示金色
- [x] 5.4 確認 Sidebar hover 顏色為朱砂紅
